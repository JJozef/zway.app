...
export const FileCode2Icon = ({ className }) => (
  <svg
    className={cn('h-6 w-6 min-w-6', className)}
    viewBox='0 0 24 24'
    strokeWidth='1.5'
...
export const TerminalIcon2 = ({ className }) => (
  <svg
    className={cn('h-6 w-6 min-w-6', className)}
    viewBox='0 0 24 24'
    strokeWidth='1.5'
...
export const ArrowUpRightSquareIcon = ({ className }) => (
  <svg
    className={cn('h-6 w-6 min-w-6', className)}
    viewBox='0 0 24 24'
    strokeWidth='1.5'
...
export const PanelsTopLeftIcon = ({ className }) => (
  <svg
    className={cn('h-6 w-6 min-w-6', className)}
    viewBox='0 0 24 24'
    strokeWidth='1.5'
...
export const Laptop2Icon = ({ className }) => (
  <svg
    className={cn('h-6 w-6 min-w-6', className)}
    viewBox='0 0 24 24'
    strokeWidth='1.5'
...
export const ScreenShareIcon = ({ className }) => (
  <svg
    className={cn('h-6 w-6 min-w-6', className)}
    viewBox='0 0 24 24'
    strokeWidth='1.5'
